"""Apply or remove the local rag_reader filesystem policy."""
...
DEFAULT_PATHS = [ROOT / "storage/chroma", ROOT / "shared_output/Q2_RAG_Demo/storage/chroma"]
...
def set_access(root: Path, locked: bool) -> int:
    ...
    # Children first when locking; root first when unlocking.
